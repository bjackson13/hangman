...
-- Fri 02 Oct 2020 08:12:19 PM EDT
...
-- -----------------------------------------------------
-- Table `btj9560`.`UserIdentifiers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `btj9560`.`UserIdentifiers` ;

CREATE TABLE IF NOT EXISTS `btj9560`.`UserIdentifiers` (
  `UserId` INT NOT NULL,
  `IP` VARCHAR(15) NOT NULL,
  `UserAgent` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`UserId`),
  CONSTRAINT `fk_UserIdentifiers_user`
    FOREIGN KEY (`UserId`)
    REFERENCES `btj9560`.`User` (`UserId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
